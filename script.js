...
const students = [
	{
		"question": "phòng chờ tiếng anh là gì",
		"name" : "sitting room",
		"image": "assets/sittingroom.jpg",
	},
	{
		"question": "phòng hút thuốc tiếng anh là gì",
		"name" : "smoking room",
		"image": "assets/Smoking_room.jpg",
	},
	{
		"question": "nữ nhân viên phục vụ phòng?",
		"name" : "chambermaid",
		"image": "assets/chambermaid.jpg",
	},
	{
		"question": "nhân viên phục vụ phòng",
		"name" : "housekeeper",
		"image": "assets/housekeeper.jpg",
	},
	{
		"question": "nhân viên hành lý",
		"name" : "bellman",
		"image": "assets/bellman.jpg",
	},
	{
	...
	},
	{
		...
		"question": "tôi đang tìm tên bạn trên hệ thống",
		"name" : "i am trying to look you up on our system",
		"image": "assets/systemlook.jpg",
	},
...
console.log(...students.keys("question"))
...
const newRound = function() {
    ...
    gameContainerHeadingEl.innerText = `question ${currentGameResult.length + 1} - ${secretStudent.question}`;
